...
namespace AwesomeCharts {
    ...
    public class LineChart : AxisBaseChart<LineData> {
        ...
        public List<LineEntryIdicator> entryIdicators = new List<LineEntryIdicator> ();
        ...
        public void OnEntryClick (LineEntryIdicator indicator, int dataSetIndex) {
        ...
        public void ShowHideValuePopup (LineEntryIdicator indicator, Transform parent = null) {
            if (currentValuePopup == null) {
                ...
                if(parent != null) {
                    ...
                    p = contentView.transform;
                }

                currentValuePopup = viewCreator.InstantiateChartPopup (p, Config.PopupPrefab);
            }
        ...
        public void ShowValue(LineEntryIdicator indicator) {
        ...
        private void UpdateValuePopup (LineEntryIdicator indicator) {
            ...
            currentValuePopup.date.text = "At " + indicator.entry.Extras.Split('&')[0];
            currentValuePopup.volume.text = "Vol: " + indicator.entry.Extras.Split('&')[1] + "<size=20> USD </size>";
        ...
        private Vector3 PopupPositionFromEntry (LineEntryIdicator indicator) {
            return new Vector3 (indicator.transform.localPosition.x,
                indicator.transform.localPosition.y + 200,
                0);
        }
